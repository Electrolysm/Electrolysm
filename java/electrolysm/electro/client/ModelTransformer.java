...
public class ModelTransformer extends ItemBlockModelBase
{
    //fields
    ...
    public ModelTransformer()
    {
        ...
        setRotation(heatSink1, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink2, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink3, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink4, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink5, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink6, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink7, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSink8, 0F, 0F, ((float)Math.PI / 4F));
        ...
        setRotation(heatSinkInner, 0F, 0F, ((float)Math.PI / 4F));
