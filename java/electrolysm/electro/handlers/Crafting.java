...
*/
    ...
    GameRegistry.addRecipe(new ItemStack(Electrolysm.grindStone, 1, 0),
        ...
        GameRegistry.addRecipe(new ItemStack(Electrolysm.insulatedScrewdriver), new Object[]{
                "I  ", " Y ", " R ",
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Electrolysm.improvedFurnace, 1, 3), true, new Object[]{
                "III", "SFS", "SSS",
                Character.valueOf('S'), "ingotSteel",
                Character.valueOf('I'), Items.iron_ingot,
                Character.valueOf('F'), Blocks.furnace}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Electrolysm.energyMeter, 1), true, new Object[]{
                "C C", "CAC", "S S",
                Character.valueOf('S'), Electrolysm.BasicMicrochip,
                Character.valueOf('C'), "ingotCopper",
