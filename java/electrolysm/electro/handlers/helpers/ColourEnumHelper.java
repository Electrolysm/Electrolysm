...
public enum ColourEnumHelper {
    ...
    public static ColourEnumHelper[] DYES = new ColourEnumHelper[] {BLACK, DARK_RED, DARK_GREEN, null, DARK_BLUE, PURPLE, DARK_AQUA, GREY, DARK_GREY, PINK, BRIGHT_GREEN, YELLOW, INDIGO, RED, ORANGE, WHITE};
    ...
    private ColourEnumHelper(String s, String n, int[] rgb, int meta)
    {
        code = s;
        unlocalizedName = n;
        rgbCode = rgb;
