...
import electrolysm.electro.oreProccessing.improvedFurnace;
 ...
 * to the code.
 */
public class TileEntityImprovedFurnace extends TileEntity implements IInventory, ISidedInventory{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                improvedFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
