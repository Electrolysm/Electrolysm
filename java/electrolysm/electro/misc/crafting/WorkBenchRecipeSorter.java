package electrolysm.electro.misc.crafting;
...
class WorkBenchRecipeSorter implements Comparator
{
    ...
    WorkBenchRecipeSorter(WorkBenchCraftingManager par1CraftingManager)
    {
        this.bettercraftingManager = par1CraftingManager;
    }
