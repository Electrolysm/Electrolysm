...
import electrolysm.api.powerSystem.tesla.IWorldMethods;
...
public class CompareHandler {
    ...
    public static Comparator<Receiver> comparatorReceiver = new Comparator<Receiver>() {
        @Override
        public int compare(Receiver te1, Receiver te2) {
            if (te1 != null && te2 != null) {
                if (te1.getFreq() - te2.getFreq() == 0) {
                    if (te1.getWorld() == null && te2.getWorld() == null) {
                        if (te1.getWorldData()[0] - te2.getWorldData()[0] == 0) {
