 ...
 * to the code.
 */
public class GuiAdvCore extends GuiContainer{

    private TileEntityAdvCore entity;

    public GuiAdvCore(TileEntityAdvCore entity, InventoryPlayer inventory)
    {
        super(new ContainerAdvCore(entity, inventory));
        this.entity = entity;
    }
