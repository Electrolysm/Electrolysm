 ...
 * to the code.
 */
public class GuiCreativeCore extends GuiContainer{

    private TileEntityCreativeCore entity;

    public GuiCreativeCore(TileEntityCreativeCore entity, InventoryPlayer inventory)
    {
        super(new ContainerCreativeCore(entity, inventory));
        this.entity = entity;
    }
