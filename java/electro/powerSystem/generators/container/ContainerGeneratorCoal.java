...
public class ContainerGeneratorCoal extends Container
{
    private TileEntityGeneratorCoal entity;

    public ContainerGeneratorCoal(TileEntityGeneratorCoal entity, InventoryPlayer inventory)
    {
        this.entity = entity;
        
        this.addSlotToContainer(new Slot(entity, 0, 80, 49)); //top left
        
        this.addSlotToContainer(new SlotBattery(entity, 1, 15, 15)); //top left
