...
public class BlockAdvGenAcive extends BlockEnergy
{
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        frontIcon = reg.registerIcon("electrolysm:advGeneratorFrontActive");
    }
    ...
    {
        if(par1World.getTileEntity(par2, par3, par4) instanceof TileEntityGeneratorCoal && !keepInventory)
        {
