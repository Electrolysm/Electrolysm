...
public class scanner extends Item
{
    ...
    {
        System.out.println(ResearchPoint.getPoints(new ItemStack(world.getBlock(x, y, z))));
        new SavePlayerScanData(player.getDisplayName(), (new ItemStack(world.getBlock(x, y, z))).getUnlocalizedName());
        return false;
    }
