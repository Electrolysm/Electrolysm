 ...
 */
public class RenderTileTesla extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float f1) {
        ...
        if(configHandler.useSpheres) {
            ...
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            bindTexture(new ResourceLocation(CommonProxy.MOD_ID_LOWER, "textures/models/obj/tesla_ball.png"));
            ...
            GL11.glPushMatrix();
            bindTexture(new ResourceLocation(CommonProxy.MOD_ID_LOWER, "textures/models/obj/tesla_ball_red.png"));
