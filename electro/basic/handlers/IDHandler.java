...
public class IDHandler {
	...
	public static int tumbagaID = startingID + 30;
	public static int babbittID = startingID + 31;
	public static int pewterID = startingID + 32;
	public static int sydiumID = startingID + 33;
	public static int tibetanSilverID = startingID + 34;
	...
	public static int reConcreteID = 667;
	public static int reGlassID = 668;
	public static int name = 669;
	...
	public static class robotics{
		...
		public static int servoID = 702;
		public static int artMuscleID = 703;
		public static int carbonBoneID = 704;
		public static int bionicArmID = 705;
		public static int bionicLegID = 706;
		public static int bionicChestID = 707;
		public static int bionicHeadID = 708;
		public static int microContID = 709;
