...
public class ContainerMagmaticExtractor extends Container
{
	private TileEntityMagmaticExtractor entity;
	
	public ContainerMagmaticExtractor(TileEntityMagmaticExtractor entity, InventoryPlayer inventory)
	{
		this.entity = entity;
