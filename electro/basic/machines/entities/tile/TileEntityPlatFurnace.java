...
public class TileEntityPlatFurnace extends TileEntity implements IInventory {
	...
	private boolean canDoubleSmelt()
	{
		...
		{
			ItemStack itemstack = platRecipes.smelting().getDoubleSmeltingResult(this.inventory[0], this.inventory[1]);

			if (itemstack == null) return false;
			if (this.inventory[0].stackSize < platRecipes.smelting().getSlot1ReduceAmount(this.inventory[0]).stackSize) return false;
			if (this.inventory[1].stackSize < platRecipes.smelting().getSlot2ReduceAmount(this.inventory[1]).stackSize) return false;
	...
	public void smeltDoubleItem()
	{
		if (this.canDoubleSmelt())
		{
			...
			this.inventory[0].stackSize -= platRecipes.smelting().getSlot1ReduceAmount(this.inventory[0]).stackSize;
			this.inventory[1].stackSize -= platRecipes.smelting().getSlot2ReduceAmount(this.inventory[1]).stackSize;
