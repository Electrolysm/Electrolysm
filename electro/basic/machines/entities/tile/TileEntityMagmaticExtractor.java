...
import mods.Electrolysm.electro.basic.recipes.MagmaticRecipes;
...
public class TileEntityMagmaticExtractor extends TileEntity implements IInventory{
	...
	public TileEntityMagmaticExtractor() {
	...
	public void updateEntity() {
		...
		if (canwork) {
			...
			ItemStack result = MagmaticRecipes.smelting().getSmeltingResult(stack);
