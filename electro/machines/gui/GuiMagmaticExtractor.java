...
public class GuiMagmaticExtractor extends GuiContainer
{
	private TileEntityMagmaticExtractor entity;

	public GuiMagmaticExtractor(TileEntityMagmaticExtractor entity,	InventoryPlayer inventory)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) 
	{
		...
		this.mc.renderEngine.bindTexture("/mods/electrolysm/textures/gui/MagmaticExtractGUI.png");
