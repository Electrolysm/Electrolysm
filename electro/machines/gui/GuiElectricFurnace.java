...
{
	private TileEntityElectricFurnace entity;

	public GuiElectricFurnace(TileEntityElectricFurnace entity,	InventoryPlayer inventory)
	{
		super(new ContainerElectricFurnace(entity, inventory));
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) 
	{
		...
		this.mc.renderEngine.bindTexture("/mods/electrolysm/textures/gui/ForgeGUI.png");
	...
	{
		fontRenderer.drawString(entity.getInvName(), 30, 6, 4210752);
