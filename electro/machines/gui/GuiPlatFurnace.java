...
public class GuiPlatFurnace extends GuiContainer
{
	private TileEntityPlatFurnace inventoryFurnace;

	public GuiPlatFurnace(InventoryPlayer inventoryPlayer, TileEntityPlatFurnace tileFurnace)
	{
		super(new ContainerPlatFurnace(inventoryPlayer, tileFurnace));
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		mc.renderEngine.bindTexture("/mods/Electrolysm/textures/gui/platFurnaceGUI.png");
