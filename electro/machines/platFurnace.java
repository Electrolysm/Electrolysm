...
public class platFurnace extends BlockContainer {
	...
	public platFurnace(int id, String textureName) {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("Electrolysm:" + "platinum");
        this.furnaceIconFront = par1IconRegister.registerIcon("Electrolysm:" + IDName);
        this.furnaceIconTop = par1IconRegister.registerIcon("Electrolysm:" + "platinum");
    }
