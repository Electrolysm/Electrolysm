...
public class battery1 extends Item {

	public static int capacity;
	public static int tier;
	
	public battery1(int id, int cap, int tier1) {
		super(id);
    ...
    {
    	list.add(new ItemStack(electrolysmCore.battery1, 1, (capacity - capacity)));
    	list.add(new ItemStack(electrolysmCore.battery1, 1, capacity));
    }
