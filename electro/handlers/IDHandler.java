...
public class IDHandler {
	...
	public static int ferrousDustID = startingID + 10;
	public static int leadDustID = startingID + 11;
	public static int silverDustID = startingID + 12;
	...
	public static int hiddenIngotID = startingID + 24;
	
	public static int ionicElectrumID = startingID + 25;
	public static int ironisedGoldID = startingID + 26;
	public static int tumbagaID = startingID + 27;
	public static int babbittID = startingID + 29;
	public static int pewterID = startingID + 30;
	public static int sydiumID = startingID + 31;
	public static int tibetanSilverID = startingID + 32;
	
	public static int atomyBookID = startingID + 33;
	public static int glassLensID = startingID + 34;
	public static int nanoTechID = startingID + 35;
	public static int nanoBlockID = startingID + 36;
	public static int deskID = startingID + 37;
	public static int fibrePlantID = startingID + 38;
	public static int stickyStringID = startingID + 39;
	public static int platinumID = startingID + 40;
}
