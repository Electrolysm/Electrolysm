...
public class furrobabbitt extends hiddenIngot {

	private static final String itemIDName = "furrobabbitt";

	public furrobabbitt(int par1) {
		super(par1);
    ...
    {
		Object whatIngot = "Flexable and alright conduction of energy but very strong";
