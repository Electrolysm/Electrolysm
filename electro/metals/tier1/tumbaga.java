...
public class tumbaga extends hiddenIngot {

	private static final String itemIDName = "tumbaga";

	public tumbaga(int par1) {
		super(par1);
    ...
    {
		Object whatIngot = "A good strong power conductor";
