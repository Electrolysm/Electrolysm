...
public class sydium extends hiddenIngot {

	private static final String itemIDName = "sydium";

	public sydium(int par1) {
		super(par1);
    ...
    {
		Object whatIngot = "Posionous and flammable metal, be carefull";
