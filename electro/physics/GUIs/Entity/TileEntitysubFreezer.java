package mods.Electrolysm.electro.physics.GUIs.Entity;
...
public class TileEntitysubFreezer extends TileEntity implements IInventory
{
    ...
    public TileEntitysubFreezer adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntitysubFreezer adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntitysubFreezer adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntitysubFreezer adjacentChestZPosition;
    ...
    private void func_90009_a(TileEntitysubFreezer par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntitysubFreezer)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntitysubFreezer)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntitysubFreezer)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntitysubFreezer)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
